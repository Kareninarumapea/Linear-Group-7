...
# Page for Home
if selected == 'Home':
    st.image("https://github.com/Achphasesyafiq/line/blob/main/Logo%20PU.png?raw=true", width=550)
...
# Page for Member of Group
    ...
    st.image("https://github.com/Achphasesyafiq/line/blob/main/Jofan.jpeg?raw=true", width=150)
